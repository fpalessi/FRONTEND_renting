...
const UploadImage = ({ addedPhotos, onChange }) => {
  const uploadImage = (e) => {
  ...
  return (
    <>
      <label htmlFor="photo-url" className="text-gray-800 text-lg">
        Fotografías (cuantas más mejor)
      </label>
      <div className="w-1/4 my-2">
        {/* Si el tamaño es mayor que 0 (hay fotos ya subidas) que las muestre
        (mapea el array) */}
